...
public class ReturnCreation3PageElements {
    ...
    public final static String COLOR_OF_SHRINK_FIELD_XPATH = "//*[@class='info-table-wrapper visible-lg-block']//input[@name='colorOfShrinkSharp']";
    public final static String ADDITIONAL_INFO_FIELD_XPATH = "//*[@class='info-table-wrapper visible-lg-block']//textarea[@name='shortageAdditionalInformation']";
    public final static String SAVE_BUTTON_XPATH = "//*[@class='info-table-wrapper visible-lg-block']//button[@class='btn primary-btn pull-right return-info-flyout-submit']";
