...
public class PDPPageElements {
    ...
    public final static String ALL_PRODUCT_DETAILS_TABLE_ITEMS_XPATH = "//div[@id='product-details']//table/tbody/tr/td[1]/span";
    public final static String ALL_PRICING_DETAILS_TABLE_ITEMS_XPATH = "//div[@id='price-availability']/div[5]/div/table/tbody/tr/td[1]";
