...
public class PriceAndAvailabilityPageElements {
    ...
    public final static String QTY_FIELD_XPATH = ".//input[@class='form-control catalog-qty-input-col onchange-warning qty-desk']";
    ...
    public final static String AVAILABILITY_FIELD_XPATH = ".//*[@id='price-item-tr-1']/td[10]/a";
}
