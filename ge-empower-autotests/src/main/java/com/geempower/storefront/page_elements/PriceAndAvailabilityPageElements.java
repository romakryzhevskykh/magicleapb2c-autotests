...
public class PriceAndAvailabilityPageElements {
    ...
    public final static String QUANTITY_FIELD_BY_CATALOG_NO_XPATH = "//table[contains(@class, 'price-availability-table')]//tr[contains(@class, 'price-item') and td/a[@data-product = '%s']]/td[contains(@class,'qty-input')]/input";
    public final static String QUANTITY_FIELD_XPATH = "//td[@class='qty-input-col qty-input']//input";
