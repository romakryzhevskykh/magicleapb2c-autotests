...
public class OrderDetailsPageElements {
    ...
    public final static String SINGLE_STATUS_BOX_XPATH = "//a[@data-status='%s']";
    public final static String SINGLE_STATUS_BOX_PRICE_VALUE_XPATH = "//a[@data-status='%s']//p[@class='item-price text-bold']";
