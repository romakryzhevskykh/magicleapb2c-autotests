...
public class AccountManagementPageElements {
    ...
    public final static String STAR_ICON_FOR_APPROPRIATE_ACCOUNT_ON_APPROVED_ACCOUNT_TAB_XPATH = ".//*[@id='activeRequestsTable']/tbody/tr[1]/td[text()='%s']/..//td[@class=' table-visible-lg-block']//i[@class='fa fa-star-o']";
    public final static String STAR_ICON_FOR_APPROPRIATE_ACCOUNT_ON_FAVORITES_TAB_XPATH = "//table[@id='favoritesTable']/tbody/tr/td[text()='%s']/..//td[@class=' table-visible-lg-block']//i[@class='fa  fa-star']";
