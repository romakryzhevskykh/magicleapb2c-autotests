...
public class AccountManagementPageElements {
    ...
    public final static String REGION_COMBOBOX_ID = "select2-region-container";
    public final static String APPROPRIATE_REGION_BY_NAME_XPATH = "//ul[@class='select2-results__options']/li[text()='%s']";
    public final static String SEARCH_FIELD_ID = "searchAccount";
    ...
    private final static String PENDING_REQUESTS_TABLE_XPATH = "//table[@id='pendingApprovalTable']";
    public final static String PENDING_ACCOUNTS_COLUMN_ON_PENDING_FOR_APPROVAL_TAB_XPATH = PENDING_REQUESTS_TABLE_XPATH + "/tbody/tr[%s]/td[2]";
    public final static String MORE_ACTIONS_THREE_DOT_ICON_XPATH = PENDING_REQUESTS_TABLE_XPATH + "/tbody/tr[1]/td[last()]/ul/li/a/i";
    public final static String CANCEL_REQUEST_BUTTON_XPATH = PENDING_REQUESTS_TABLE_XPATH + "/tbody/tr[1]/td[last()]/ul/li[@class='action-detail open']/ul[@class='dropdown-menu dropdown-list more-action-dropdown']/li/a";
    ...
    private final static String ACTIVE_REQUESTS_TABLE_XPATH = "//table[@id='activeRequestsTable']";
    public final static String FULL_INFO_OF_FIRST_ACCOUNT_APPROVED_ACC_TAB_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "/tbody/tr[1]/td[2]/a";
    public final static String PENDING_FOR_APPROVAL_TABLE_NO_DATA_TITLE_XPATH = PENDING_REQUESTS_TABLE_XPATH + "//td";
    public final static String APPROVED_ACCOUNTS_TAB_XPATH = "//a[@href='#recently-viewed']";
    public final static String APPROVED_ACCOUNTS_NO_IN_APPROVED_ACCOUNTS_TABLE_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "/tbody/tr/td[2]";
    public final static String APPROVED_ACCOUNTS_NAME_IN_APPROVED_ACCOUNTS_TABLE_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "//td[contains(@class,'account-name-col')]";
    ...
    public final static String CONFIRMATION_FOR_REMOVE_ACTIVE_ACCOUNT_BUTTON_ID = "removeActiveBtn";
    public final static String FAVORITES_ACTIVE_TAB_XPATH = "//li[contains(@class,'active') and contains(@tab-id ,'1')]";
    public final static String APPROVED_ACCOUNTS_LIST_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "/tbody/tr/td[2]/a";
    public final static String APPROVED_ACCOUNTS_TABLE_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "/tbody/tr/td[1]";
    ...
    public final static String PRE_AUTH_SEND_REQUEST_BUTTON_ID = "sendPreauthorizeRequestBtn";
    ...
    public final static String RED_EXCLAMATION_TRIANGLE_ICON_XPATH = ACTIVE_REQUESTS_TABLE_XPATH + "//i[@class='fas fa-exclamation-triangle']";
