...
public class RebatesPageElements {
    ...
    public final static String EDIT_LAST_SAVED_REQUEST_ICON_XPATH = LAST_SAVED_REBATES_XPATH + "//i[@class='fa fa-pencil']";
    public final static String DELETE_LAST_SAVED_REQUEST_ICON_XPATH = LAST_SAVED_REBATES_XPATH + "//i[@class='fa fa-trash']";
