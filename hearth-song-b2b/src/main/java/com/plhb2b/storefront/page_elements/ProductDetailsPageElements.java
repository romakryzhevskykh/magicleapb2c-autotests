package com.plhb2b.storefront.page_elements;
...
public class ProductDetailsPageElements {
    ...
    public static final String PRODUCT_ROW_BY_SKU_XPATH = "//li[contains(@class, 'product-listing-item nav') and div[contains(@class,'clearfix')]/div[contains(@class,'product-action-button')][@data-product-code='%s']]";
