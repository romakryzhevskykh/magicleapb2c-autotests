Feature: Check user restrictions with MANAGE SUPPLY LISTS PERMISSION and without it.
  ...
  Background:
    ...
    And Test user group has only MANAGE_SUPPLY_LISTS permission.
    And Test user has no any roles ORGANIZATION_TEST_USER.
    And Test user has only test user group assigned.

  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Supply lists drop-down in header.
    When Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Refresh page.
    Then Check that Supply lists drop-down is present in Header.

  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Supply lists item in My Account drop-down.
    When Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And My Account menu is opened.
    Then Check that Supply Lists item is present in My Account menu.

  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Supply lists item on Account Dashboard page.
    When Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to favorite checkbox on Supply lists page.
    When Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Remove button for his own Supply list on Supply lists page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to favorite checkbox on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Add to cart button and QTY field on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Add to Supply list button on PDP.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    When PDP for INDIVIDUAL, VALID product.
    Then Check that Add to Supply list button is visible on PDP.

  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Add to Supply list button on Cart page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Quick add functionality for his owm Supply list on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Edit button for his own Supply list on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Activate/Inactivate button for his own Supply list on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
  ...
  Scenario: Check that user with only MANAGE SUPPLY LISTS PERMISSION has access to Share functionality on Supply list details page.
    Given Switch to Storefront cockpit test user ORGANIZATION_TEST_USER.
    And User is logged in to Storefront.
    And Active Supply list exists.
    When Opened Supply list details page.
