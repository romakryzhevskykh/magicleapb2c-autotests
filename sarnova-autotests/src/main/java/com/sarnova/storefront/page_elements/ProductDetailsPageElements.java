...
public class ProductDetailsPageElements {
    ...
    public static final String PRODUCT_ROW_BY_SKU_XPATH = "//li[contains(@class, 'product-listing-item nav') and div[@class='clearfix']/div[contains(@class,'product-action-button')][@data-product-code='%s']]";
