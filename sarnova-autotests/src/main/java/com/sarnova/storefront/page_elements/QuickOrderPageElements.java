...
public class QuickOrderPageElements {
    ...
    public static final String RESET_FORM_BUTTON_POP_UP_XPATH = "//div[@id='cboxContent']//div[@class='row']/div[1]/button";//"//button[contains(@class, 'js-resetQuickOrderForm_delete_confirm')]";
