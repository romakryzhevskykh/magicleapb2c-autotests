...
public class LoginPageElements {
    ...
    public static final String USERNAME_LABEL = "//label[@for = 'j_username']";
    public static final String USERNAME_FIELD_ID = "j_username";
    public static final String PASSWORD_LABEL = "//label[@for = 'j_password']";
