...
public class SupplyListDetailsPageElements {
    ...
    public static final String EDIT_SUPPLY_LIST_BUTTON_XPATH = "//a[@class = 'js-edit-wishlist-link edit-wishlist-link']/button";
    ...
    public static final String QUICK_ADD_ROWS = QUICK_ADD_SUPPLY_LIST_BLOCK_XPATH + "//li[@class='item__list--item js-li-container product-listing-item']";
    ...
    public static final String QUICK_ADD_TO_THIS_SUPPLY_LIST_BUTTON_XPATH = "//button[contains(@class,'btn btn-block btn-default js-add-to-list-btn')]";
}
