...
public class LoggedInHeaderRowBlockElements {
    ...
    private static final String MY_ACCOUNT_CONTAINER_XPATH = "//div[@class='my-account-container col-sm-6']";
    ...
    public static final String MY_ACCOUNT_MENU_ITEMS_XPATH = MY_ACCOUNT_DROP_DOWN_CONTENT_XPATH + "/li[not(@id='orgAccountsSelector')]";
    public static final String MY_ACCOUNT_MENU_ITEM_NAMES_XPATH = MY_ACCOUNT_MENU_ITEMS_XPATH + "/a";
    ...
    public static final String PREVIOUSLY_ORDERED_ITEMS_ITEM_XPATH = MY_ACCOUNT_MENU_ITEMS_XPATH + "/a[@title = 'Previously Ordered Items']";
