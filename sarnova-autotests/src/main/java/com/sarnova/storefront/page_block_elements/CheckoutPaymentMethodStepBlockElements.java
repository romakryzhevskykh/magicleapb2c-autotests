...
public class CheckoutPaymentMethodStepBlockElements {
    ...
    public static final String CREDIT_CARD_DETAILS_BLOCK_XPATH = "//div[@id='creditCardDetails']";
    public static final String CREDIT_CARD_FORM_FIELDS_XPATH = CREDIT_CARD_DETAILS_BLOCK_XPATH + "/*";
    ...
    public static final String BILLING_ADDRESS_IS_THE_SAME_AS_SHIPPING_ADDRESS_SELECTBOX_XPATH = "//label[@for='changeBillingAdress_false']/div/div";
    public static final String BILLING_ADDRESS_IS_THE_SAME_AS_SHIPPING_ADDRESS_CHECKBOX_XPATH = "//input[@name='changeBillingAddress']";
