...
public class PurchaseSummaryPage extends StorefrontBasePage {
    ...
    @Step ("Is Quick Add Products Visible?")
    public void clickOnAddProductCheckBox() {click(By.id(QUICK_ADD_PRODUCTS_CHECKBOX_ID));}

    @Step ("Is product search Visible?")
    public boolean isProductSearchIdVisible() {return isDisplayed(By.id(PRODUCT_SEARCH_ID));}
