...
public class OrderReviewPageElements {
	...
	public static final String XPATH_SHIPPING_INFO = "//div[@class='esab-ui-container']//div//b[text()='Ship To Address:']//parent::div//parent::div[@class='row row__bottom-margin']";
